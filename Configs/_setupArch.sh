...
printf "\n\nDownloading..."
sudo pacman -S os-prober ntfs-3g xorg-server i3-gaps i3blocks i3status dmenu lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings
sudo pacman -S konsole dolphin git network-manager-applet nftables pulseaudio pulseaudio-alsa kmix notification-daemon dunst 
